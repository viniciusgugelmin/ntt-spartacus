...
import {SearchBoxComponentService} from './custom-search-box-component.service';
import {
  SearchBoxProductSelectedEvent,
  SearchBoxSuggestionSelectedEvent,
} from './custom-search-box.events';
import {SearchBoxConfig, SearchResults} from './custom-search-box.model';
...
export class CustomSearchBoxComponent implements OnInit, OnDestroy {
  @Input() config: SearchBoxConfig | undefined;
  ...
  protected config$: Observable<SearchBoxConfig> = (
    ...
    map((config) => {
      const isBool = (obj: SearchBoxConfig, prop: keyof SearchBoxConfig): boolean =>
        obj?.[prop]?.toString() !== "false";
